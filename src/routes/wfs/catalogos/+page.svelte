<script>
    ...
    import {countTotalLayer, countTotalLayerWithoutMetadata, countProcessado} from '$lib/store/storeWFS'
...
<div class = "m-2 grid gap-2 md:grid-cols-3 grid-cols-1">
        ...
        {#each selectedCatalogs as objIdDescricaoIri}
            <WFSCatalogCard objIdDescricaoIri={objIdDescricaoIri} ></WFSCatalogCard>
        {/each}
</div>