...
<div class = "">
    ...
    {#each selectedCatalogs as idDescricaoIriNoCentralCategoria, j (j)}
        <CSWKeywordCard objIdDescricaoIriNoCentralCategoria={idDescricaoIriNoCentralCategoria} ></CSWKeywordCard>
        
    {/each}
    <div class = "m-2 grid gap-2 md:grid-cols-4 grid-cols-2">
        {#each Object.entries($keywordCSWCountByName) as keyCount, i (i)}
